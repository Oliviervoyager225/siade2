...
class _LocationState extends State<Location> {
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildModeButton("3 min", Icons.directions_car, selected: true),
  ...
  Widget _buildModeButton(String text, IconData icon,
      {bool selected = false}) {
    return Container(
  ...
  Widget _routeInfoBox(
      String time, String label, Color color, IconData icon) {
    return Container(
