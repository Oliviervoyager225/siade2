...
class RocketExhaustPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paintFill = Paint()
      ..color = const Color.fromARGB(255, 144, 8, 251)
      ..style = PaintingStyle.fill;

    final paint1Fill = Paint()
      ..color = const Color.fromARGB(255, 168, 70, 253)
      ..style = PaintingStyle.fill;
...
class RocketExhaustWidget extends StatefulWidget {
  ...
  const RocketExhaustWidget({super.key, required this.launchProgress});
...
class _RocketExhaustWidgetState extends State<RocketExhaustWidget>
  ...
  void initState() {
    ...
    _bottomWidthAnimation = CurvedAnimation(
      ...
      curve: const SteepEndCurve(steepness: 30.0),
    );
